    ...
    public partial class Students : System.Web.UI.Page
    {
        ...
        protected void StudentsGridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if(e.CommandName == "edit_student")
            {
                ...
                GradesRepeater.DataSource = student.PriorCourses;
                GradesRepeater.DataBind();
        ...
        protected void SendSurveyLinkMessage(Student student)
        {
            ...
            link = "https://grouperapp.azurewebsites.net?id=" + student.GUID;
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (student != null)
                {
                    ...
                    if (student.Languages != null)
                    {
                        ...
                        {
                            languages += "<table border='1' style='width: 100%; font-size: .9em;'>";
                            foreach (ProgrammingLanguage language in student.Languages)
                            {
                                languages += "<tr><td><span class='no-wrap'>" + language.Name + " - " + language.ProficiencyLevel.ToString() + "</span></td></tr>";
                            }
                            languages += "</table>";
                        }
                    }
                    ...
                    if (student.InterestedRoles != null)
                    {
                        ...
                        {
                            roles += "<table border='1' style='width: 100%; font-size: .9em;'>";
                            foreach (Role role in student.InterestedRoles)
                            {
                                roles += "<tr><td><span class='no-wrap'>" + role.Name + " - " + role.InterestLevel.ToString() + "</span></td></tr>";
                            }
                            roles += "</table>";
                        }
                    }
                    ...
                    if (student.Skills != null)
                    {
                        ...
                        {
                            skills += "<table border='1' style='width: 100%; font-size: .9em;'>";
                            foreach (Skill skill in student.Skills)
                            {
