...
<asp:Panel ID="ImportStudentsPanel" runat="server" CssClass="panel panel-default" Visible="false">
    ...
    <asp:GridView ID="StudentsGridView" runat="server" CssClass="table table-bordered table-condensed small" DataKeyNames="StudentID" AutoGenerateColumns="false" OnRowCommand="StudentsGridView_RowCommand" OnRowDataBound="StudentsGridView_RowDataBound">
        <EmptyDataTemplate>
            ...
            <asp:TemplateField HeaderText="Survey Submitted">
                <ItemTemplate>
                    <table style="">
                        <tr>
                            <td>
                                <asp:Label ID="SubmittedDateLabel" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                <asp:Repeater ID="GradesRepeater" runat="server">
                    <HeaderTemplate>
